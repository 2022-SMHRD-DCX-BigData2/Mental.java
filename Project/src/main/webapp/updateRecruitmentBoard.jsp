...
<body>
    <div class="container-xxl bg-white p-0">
                    ...
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="testimonial.html" class="dropdown-item">관심 자격증</a>
		...
		<%
			...
			RecruitmentBoard board_recruitmentView = dao.recruitmentView(bd_num);
		%>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput1" name="title" placeholder="제목을 수정해주세요." value=<%=board_recruitmentView.getBd_title() %>>
            <br>
          </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">작성자</label>
            <h3><%=dao.getmemId(board_recruitmentView.getMem_no()) %></h3>
            <br>
          </div>
          <div class="form-group">
            <label for="exampleFormControlTextarea1">내용</label>
            <textarea class="form-control" id="exampleFormControlTextarea1" name="contents" rows="10">
            <%=board_recruitmentView.getBd_contents() %>
            </textarea>
            <br>
          </div>
