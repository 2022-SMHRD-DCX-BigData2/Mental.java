...
<body>
    <div class="container-xxl bg-white p-0">
		...
		<%
			...
			RecruitmentBoard board_view = dao.recruitmentView(bd_num);
		...
		<div align="right" style="margin-right: 180px;">
			...
			<%}else if(mem_id.equals(loginMember.getmem_id())){%>
		        <a href="UpdateRecruitmentBoard.jsp?bd_num=<%=board_view.getBd_num()%>"  class="btn btn-info"  style="color: white; ">수정하기</a>
	    	    <button class="btn btn-secondary" style ="text-align: right; color:white">목록으로</button>
        	<%}else{ %>
	    	    <button class="btn btn-secondary" style ="text-align: right; color:white">목록으로</button>
			<%} %>	
    ...
    function UpdateRecruitmentBoard(){
	    location.href='UpdateRecruitmentBoard.jsp?bd_num=<%=board_view.getBd_num()%>'
    }
